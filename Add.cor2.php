...
if (isset($_POST['update'])) {
	...
	$student_level = mysqli_real_escape_string($connect, $_POST['student_level']);
	 ...
	 $query = "UPDATE subject SET `student_id`='$student_name', `student_name`='$student_name', `student_course`='$student_course', `student_level`='$student_level', `updated_at`=NOW() WHERE `student_id`='$student_id'";
